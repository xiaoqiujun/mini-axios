(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["wxAxios"] = factory();
	else
		root["wxAxios"] = factory();
})(window, function() {
...
/******/ 	return __webpack_require__(__webpack_require__.s = "./libs/wxAxios.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./libs/InterceptorManager.js":
/*!************************************!*\
  !*** ./libs/InterceptorManager.js ***!
  \************************************/
...
var InterceptorManager = __webpack_require__(/*! ./InterceptorManager */ "./libs/InterceptorManager.js");
var dispatchRequest = __webpack_require__(/*! ./dispatchRequest */ "./libs/dispatchRequest.js");

var _require = __webpack_require__(/*! ./utils */ "./libs/utils.js"),
    typeOf = _require.typeOf,
    forEach = _require.forEach,
    merge = _require.merge,
    toUpperCase = _require.toUpperCase;
...
function dispatchRequest(config) {
	...
	return new _promise2.default(function (resolve, reject) {
		...
		wx.request((0, _extends3.default)({}, config, {
...
function forEach(obj, cb) {
	...
	for (var key in obj) {
		if (Object.prototype.hasOwnProperty.call(obj, key)) cb.call(null, obj[key], key, obj);
	}
}
/**
 * 将函数绑定到另个对象
...
function extendMini(a, b) {
	forEach(['get', 'post', 'put', 'delete', 'trace', 'options', 'head', 'connect'], function (method) {
		a.__proto__[method] = function (url) {
			var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
...
var wxAxios = __webpack_require__(/*! ./core */ "./libs/core.js");
...
var _require = __webpack_require__(/*! ./utils */ "./libs/utils.js"),
    ...
    extendMini = _require.extendMini;
...
function getInstance(config) {
	var ctx = new wxAxios(config);
	var instance = bind(wxAxios.prototype.request, ctx);
...
var axios = getInstance(defaultConfig);
...
axios.race = function all(promise) {
	...
	return _promise2.default.race(promise);
};
axios.axios = axios;

App = function App(_option) {
	_option.$axios = axios;
...
Page = function Page(_option) {
	_option.$axios = getApp().$axios;
	page(_option);
};
Component = function Component(_option) {
	_option.$axios = getApp().$axios;
	com(_option);
};
...
//# sourceMappingURL=wxAxios.js.map